...
import * as web3Types from '../vuex/types/web3'
      ...
      web3.version.getNetwork((err, newNetworkId) => {
        ...
        if ((!err && newNetworkId && newNetworkId !== '' && newNetworkId !== networkId) || (!newNetworkId && networkId)) {
          ...
          web3.eth.getCoinbase((err, newCoinbase) => {
            ...
            if ((!err && newCoinbase && newCoinbase !== '' && newCoinbase !== coinbase && newNetworkId === web3Types.APPROVED_NETWORK_ID) || (!newCoinbase && coinbase)) {
              window.location.reload()
